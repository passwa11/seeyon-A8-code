...
public class CooprationBanjieSection  extends BaseSectionImpl {
    @Override
    public String getId() {
        return "cooprationBanjieSection";
    }

    @Override
    public String getName(Map<String, String> map) {
        String name = Strings.isNotBlank(map.get("columnsName")) ? map.get("columnsName") : "协同所有办结";
        return name;
    }
    ...
    public BaseSectionTemplete projection(Map<String, String> map) {
        String url = "/seeyon/allItems.do?method=cooprationFinishColumnDataSection&templetIds=" + map.get("template_catagory_value");
        ...
        ht.addBottomButton("common_more_label", "/allItems.do?method=toMoreCooprationBanjie&templetIds=" + map.get("template_catagory_value"), BaseSectionTemplete.OPEN_TYPE.href.name());
        return ht;
    }
}
