...
public class AllNOBanJieSection extends BaseSectionImpl {
    @Override
    public String getId() {
        return "noBanJieSection";
    }

    @Override
    public String getName(Map<String, String> map) {
        String name = Strings.isNotBlank(map.get("columnsName")) ? map.get("columnsName") : "所有未办结";
        return name;
    }
    ...
    public BaseSectionTemplete projection(Map<String, String> map) {
        String url = "/seeyon/allItems.do?method=noProcessingSection&templetIds="+map.get("template_catagory_value");
        ...
        ht.addBottomButton("common_more_label", "/allItems.do?method=toMoreOfNoBj&templetIds=" + map.get("template_catagory_value"), BaseSectionTemplete.OPEN_TYPE.href.name());
        return ht;
    }
}
