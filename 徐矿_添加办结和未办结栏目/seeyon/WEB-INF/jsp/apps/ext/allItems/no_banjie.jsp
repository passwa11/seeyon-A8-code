...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <c:forEach var="finish" items="${list}">
        <tr>
            <td style="font-size:14px" width="40%" onclick="xkjtOpen(this,'${finish.id}','${finish.edoc_type}')"><a
                    href="javascript:void(0);">${finish.subject}</a></td>
            <td width="20%" align="center"><span
                    title="<fmt:formatDate value='${finish.create_time}' pattern='yyyy-MM-dd' />"><fmt:formatDate
                    value='${finish.create_time}' pattern='yyyy-MM-dd'/></span></td>
            <td style="color:#505050" width="10%" align="center">
                <span  style="width:5px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"
                    title="${finish.name}">${finish.name}</span></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
