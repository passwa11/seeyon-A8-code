...
//            List<ZJsonObject> zJsonObjectList = new ArrayList<>();
            ...
            for (int i = 0; i < excludeExist.size(); i++) {
                ...
                if (i < listJson.size()) {
                    ...
                    subTemp5.put("showValue", zJsonObject.getZsort());
                    subTemp5.put("showValue2", zJsonObject.getZsort());
                    subTemp5.put("value", zJsonObject.getZsort());
                    int count = 1;
...
//                                       @QueryParam("dataInfo") String dataInfo,
//                                       @QueryParam("flag") String isNext) throws BusinessException {
//
//        //fastjson 解析json字符串
//        JSONObject jsonObject = JSON.parseObject(dataInfo);
//        JSONArray jsonArray = jsonObject.getJSONArray("data");
