...
<div ng-app>
    <div ng-controller="RegisterClientCtrl">
        <form:form modelAttribute="formDto" cssClass="form-horizontal">
            ...
            <div class="form-group">
                <label for="clientId" class="col-sm-2 control-label">授权应用id<em class="text-danger">*</em></label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="clientSecret" name="clientSecret" placeholder=""
