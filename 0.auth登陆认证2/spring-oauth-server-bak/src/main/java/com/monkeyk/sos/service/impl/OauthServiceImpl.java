...
public class OauthServiceImpl implements OauthService {
    ...
    @Override
    public void updateClientDetails(OauthClientDetailsDto oauthClientDetailsDto) {
        OauthClientDetails clientDetails = oauthClientDetailsDto.createDomain();
        oauthRepository.updateClientDetails(clientDetails);
    }

    @Override
    public void deleteClient(String clientid) {
        oauthRepository.deleteClient(clientid);
    }
}