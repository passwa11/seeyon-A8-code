 ...
 * @date 2012-11-15 
 */
public class GovdocSelectPeoplePanelOrgTeamImpl extends AbstractSelectPeoplePanel{
	private static final Log LOGGER = LogFactory.getLog(GovdocSelectPeoplePanelOrgTeamImpl.class);
    ...
    public String getJsonString(long memberId, long loginAccountId,String extParams) throws BusinessException {
        ...
        if(map.size()!=0){
        	...
        	LOGGER.info("orgTeamjson: "+result);
        	return result;
        }else{
        	return a.toString();
        }
