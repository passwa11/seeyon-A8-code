...
public class EdocCheckPrivDelete implements CheckPrivUpdate {
	private static final Log LOG = CtpLogFactory.getLog(EdocCheckPrivDelete.class);
    ...
    private EdocPrivDeleteAffairBatchTaskManager edocPrivDeleteAffairBatchTaskManager;
    ...
    public void setEdocPrivDeleteAffairBatchTaskManager(
			EdocPrivDeleteAffairBatchTaskManager edocPrivDeleteAffairBatchTaskManager) {
		this.edocPrivDeleteAffairBatchTaskManager = edocPrivDeleteAffairBatchTaskManager;
	}
    ...
    private String exchangeDelCheck(Collection<V3xOrgMember> newMembers,
        ...
        edocPrivDeleteAffairBatchTaskManager.addTask(taskMap);
