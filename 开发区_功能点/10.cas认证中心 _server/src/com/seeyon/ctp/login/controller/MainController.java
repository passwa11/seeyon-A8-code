...
import com.seeyon.ctp.common.constants.*;
...
//            zhou start
            if (null != service && !"".equals(service)) {
                modelAndView.addObject("ssoService", service);
            }
//            zhou end
        } else {
...
//        }
    ...
    public ModelAndView login(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String service = request.getParameter("ssoService");
        if (null != service && !"".equals(service)) {
            ModelAndView modelAndView = new ModelAndView();
            String account=request.getParameter("login_username");
...
//                        url.append("&flag=").append(map.get("memberId"));
                    ...
                    modelAndView.setViewName("redirect:" + "/main.do?service=" + service);
                    return modelAndView;
                }
