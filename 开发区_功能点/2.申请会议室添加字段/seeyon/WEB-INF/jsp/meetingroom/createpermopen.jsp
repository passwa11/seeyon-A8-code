...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="<c:url value="/apps_res/meeting/js/meeting.js" />"></script>
        ...
        function _submitCallback(errorMsg) {
            ...
            if (window.dialogArguments && window.dialogArguments.callback) {
                ...
                if (parent.window.listFrame) {
                    var href = parent.window.listFrame.location.href;
                    parent.window.listFrame.location.href = href;
                } else {
                    parent.window.close();
                }
            }
                                    ...
                                    <c:forEach items="${periodicityRoomAppList}" var="app">
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%" nowrap="nowrap" class="new-column">
                                                <input type="text" name="asset_name" inputName="<fmt:message key='mr.label.startDatetime'/>" class="input-300px" disabled
                                                       value="<fmt:formatDate value="${app.startDatetime}" pattern="yyyy-MM-dd HH:mm"/>"/>
                                            </td>
