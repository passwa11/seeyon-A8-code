	        ...
	        if(Strings.isBlank(onlySpace) || !"true".equals(onlySpace)){
	           ...
	           //获取星级
	            ...
	            if(null != serviceEndDate){
	     			...
	     			//增加不同星卡等级过期时间延长提醒
	     			if((expireDayNum<0 && (Strings.isBlank(serviceLevel)|| "1".equals(serviceLevel))) || (expireDayNum<-15 && "2".equals(serviceLevel)) || (expireDayNum<-30 && "3".equals(serviceLevel))){	     				hasserviceEndDate = "no";
	     			}else{
