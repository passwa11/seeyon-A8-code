...
public class ColSummaryDetailVO {
    ...
    private String deadlineTemplate;
     ...
     *  是否能减签 
     */
    private java.lang.Boolean canDeleteNode = true;
    
    private Integer replyCounts;//回复数(回退到待发,编辑发送保存回复数)
    ...
    public String getDeadlineTemplate() {
		return deadlineTemplate;
	}

	public void setDeadlineTemplate(String deadlineTemplate) {
		this.deadlineTemplate = deadlineTemplate;
	}
	...
	public java.lang.Boolean getCanDeleteNode() {
		return canDeleteNode;
	}
	public void setCanDeleteNode(java.lang.Boolean canDeleteNode) {
