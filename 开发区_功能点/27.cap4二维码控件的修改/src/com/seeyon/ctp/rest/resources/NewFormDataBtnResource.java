 ...
 * 应用绑定自定义按钮rest
 */
@Path("cap4/newFormDataBtn")
@Consumes({MediaType.APPLICATION_JSON})
@Produces(MediaType.APPLICATION_JSON)
public class NewFormDataBtnResource extends BaseResource  {
    /**
     * 应用绑定新建按钮处理映射数据
     */
    @POST
    ...
    public Response dealMappingData(Map<String, Object> params) {
        NewFormDataBtnManager newFormDataBtnManager = (NewFormDataBtnManager) AppContext.getBean("newFormDataBtnManager");
        return success(newFormDataBtnManager.dealMappingData(params));
    }
