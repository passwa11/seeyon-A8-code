 ...
 * @since V7.1
 */
public class ShowFormDataCtrlManagerImpl implements ShowFormDataCtrlManager {

    private static final Log LOGGER = CtpLogFactory.getLog(ShowFormDataCtrlManagerImpl.class);
    ...
    private static final String MESSAGE1 = "form.ctrl.showformdata.exception";
    private static final String CODE2 = "2002";
    private static final String MESSAGE2 = "form.ctrl.showformdata.paramNull";
    private static final String CODE4 = "2004";
    private static final String MESSAGE4 = "form.ctrl.showformdata.noShip";
    private static final String CODE5 = "2005";
    private static final String MESSAGE5 = "form.ctrl.showformdata.noData";
    private static final String CODE6 = "2006";
    private static final String MESSAGE6 = "form.ctrl.showformdata.noAuth";
    private static final String CODE7 = "2004";
    private static final String MESSAGE7 = "form.ctrl.showformdata.shipDisable";
    ...
    public Map<String, Object> getShowRecord(Map<String, Object> params) {
        ...
        try {
            ...
            FormDataMasterBean formDataMasterBean = this.getFormDataMasterBean(formBean, Long.valueOf(contentDataId), params);
            Map<String, Object> customParamMap = (Map) JSONUtil.parseJSONString(formFieldBean.getCustomParam());
            if (customParamMap == null || customParamMap.isEmpty()) {
                result.put(CODE, CODE4);
                result.put(MESSAGE, ResourceUtil.getString(MESSAGE4));
                return result;
            }
            Map<String, Object> targetFormInfo = (Map) customParamMap.get("targetFormInfo");
            ...
            if (formRelationshipBean == null || formRelationshipBean.getState() != 1) {
                ...
                FormRelationshipMapBean mapBean = formRelationshipBean.getRelationMapList().get(0);
                List<Map<String, Object>> dataList = cap4FormRelationActionManager.getSysRelationDatas(formDataMasterBean, (recordId == null ? null : Long.valueOf(recordId)), mapBean);
                if (Strings.isEmpty(dataList)) {
                    ...
                    LOGGER.info("查看控件处理穿透权限：memberId" + memberId  + ", id: " + moduleId);
                    ...
                    if(toFormBean == null && FormRelationEnums.relationApplicationType.inner.getKey().equals(formRelationshipBean.getApplicationType())){
                        FormRelationshipMapBean formRelationshipMapBean = formRelationshipBean.relationMapList.get(0);
     ...
     * 获取masterData
     */
    private FormDataMasterBean getFormDataMasterBean(FormBean formBean, Long contentDataId, Map<String, Object> params) throws BusinessException, SQLException {
