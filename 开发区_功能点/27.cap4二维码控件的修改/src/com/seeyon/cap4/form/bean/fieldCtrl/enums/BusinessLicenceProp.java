 ...
 * 营业执照可选属性
 */
public enum BusinessLicenceProp {
    ...
    BusinessLicenceProp(String key, String name,FormFieldComEnum[] supportFieldType) {
        this.key = key;
        this.name = name;
    ...
    public static List<Map<String,Object>> list(){
        ...
        for(BusinessLicenceProp businessLicenceProp : BusinessLicenceProp.values()){
            Map<String,Object> tempMap = new HashMap<String, Object>();
            tempMap.put("key",businessLicenceProp.getKey());
            tempMap.put("name",businessLicenceProp.getName());
            values.add(tempMap);
        }
        return values;
    }

    public static BusinessLicenceProp getByKey(String key) {
        for (BusinessLicenceProp type : values()) {
