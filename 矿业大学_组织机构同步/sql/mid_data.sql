...
/* Created on:     2020/6/10 15:25:38                           */
/*==============================================================*/


drop table M_ORG_DEPT cascade constraints;
...
drop table THIRD_ORG_DEPT cascade constraints;
...
(
   ...
   STATUS               VARCHAR2(20),
   constraint PK_M_ORG_DEPT primary key (ID)
);

comment on table M_ORG_DEPT is
'记录表部门';

comment on column M_ORG_DEPT.ID is
'ID';

comment on column M_ORG_DEPT.DEPT_NAME is
'部门名称';

comment on column M_ORG_DEPT.DEPT_CODE is
'部门编号';

comment on column M_ORG_DEPT.DEPT_DESCRIPTION is
'部门描述';

comment on column M_ORG_DEPT.DEPT_ENABLE is
'是否启用';

comment on column M_ORG_DEPT.DEPT_PARENT_ID is
'父部门ID';

comment on column M_ORG_DEPT.STATUS is
'状态是否同步：0未';
...
comment on column M_ORG_LEVEL.UNIT_ID is
'单位id';

comment on column M_ORG_LEVEL.LEVEL_CODE is
'职务级别编码';

comment on column M_ORG_LEVEL.LEVEL_NAME is
'职务级别名称';

comment on column M_ORG_LEVEL.LEVEL_DESCRIPTION is
'职务级别描述';

comment on column M_ORG_LEVEL.STATUS is
'状态';
...
comment on column M_ORG_MEMBER.UNIT_ID is
'单位id';

comment on column M_ORG_MEMBER.DEPT_ID is
'部门id';
...
comment on column M_ORG_MEMBER.USER_CODE is
'人员编号';

comment on column M_ORG_MEMBER.USER_NAME is
'人员姓名';

comment on column M_ORG_MEMBER.USER_TEL is
'人员移动电话';

comment on column M_ORG_MEMBER.USER_OFFICE_NUM is
'人员办公电话';

comment on column M_ORG_MEMBER.USER_SEX is
'人员性别';

comment on column M_ORG_MEMBER.USER_LOGIN_NAME is
'人员登录名称';

comment on column M_ORG_MEMBER.USER_BIRTHDAY is
'人员出生日期';

comment on column M_ORG_MEMBER.STATUS is
'状态';
...
comment on column M_ORG_POST.POST_NAME is
'岗位名称';

comment on column M_ORG_POST.POST_CODE is
'岗位编码';

comment on column M_ORG_POST.POST_DESCRIPTION is
'岗位描述';

comment on column M_ORG_POST.POST_TYPE is
'岗位类型(管理类是1，技术类是2，营销类是3，职能类是4)';

comment on column M_ORG_POST.UNIT_ID is
'单位ID';

comment on column M_ORG_POST.STATUS is
'状态';
...
comment on column M_ORG_UNIT.UNIT_NAME is
'单位名称';

comment on column M_ORG_UNIT.UNIT_CODE is
'单位编码';

comment on column M_ORG_UNIT.UNIT_DESCRIPTION is
'单位描述';

comment on column M_ORG_UNIT.UNIT_SHORT_NAME is
'单位简称';

comment on column M_ORG_UNIT.UNIT_SORT is
'单位序号';

comment on column M_ORG_UNIT.UNIT_PARENT_ID is
'父级单位id';
...
/*==============================================================*/
/* Table: THIRD_ORG_DEPT                                        */
/*==============================================================*/
create table THIRD_ORG_DEPT 
(
   ID                   VARCHAR2(50)         not null,
   DEPT_NAME            VARCHAR2(80),
   DEPT_CODE            VARCHAR2(50),
   ...
   DEPT_ENABLE          VARCHAR2(10),
   DEPT_PARENT_ID       VARCHAR2(50),
   constraint PK_THIRD_ORG_DEPT primary key (ID)
);

comment on table THIRD_ORG_DEPT is
'部门';

comment on column THIRD_ORG_DEPT.ID is
'ID';

comment on column THIRD_ORG_DEPT.DEPT_NAME is
'部门名称';

comment on column THIRD_ORG_DEPT.DEPT_CODE is
'部门编号';

comment on column THIRD_ORG_DEPT.DEPT_DESCRIPTION is
'部门描述';

comment on column THIRD_ORG_DEPT.DEPT_ENABLE is
'是否启用';

comment on column THIRD_ORG_DEPT.DEPT_PARENT_ID is
'父部门ID';
