...
//                    zhou 修改：vertical-align: middle
                    doUserName = "<IMG alt=\"" + Strings.toHTML(doUserName) + "\" style=\"vertical-align: middle;max-width:100%\" oncontextmenu=\"return false;\" src=\"" + imgStr + "\" >";
                }
            }
    ...
    private static String displayOpinionContent(FormOpinionConfig displayConfig, EdocOpinion opinion, boolean hasSignature, boolean popUserInfo, String attitude) {
        ...
        sb.append("<div id='" + opinion.getAffairId() + "' class='edocOpinion' style='clear:both;margin-top:20px;'>");
        sb.append("</div>");
