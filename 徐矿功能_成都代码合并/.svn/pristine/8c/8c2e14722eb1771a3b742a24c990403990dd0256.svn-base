...
/**
 * 
 * @ClassName: LeaderDaiYueSection  
 * @Description: 待阅栏目开发  
 * @author wxt.chenqiang
 * @date 2019年4月12日 下午3:12:31
 */
public class LeaderDaiYueSection extends BaseSectionImpl {
	...
	public String getName(Map<String, String> preference) {
		String name = Strings.isNotBlank(preference.get("columnsName")) ? preference.get("columnsName") : "待阅";
		return name;
	}
	...
	public BaseSectionTemplete projection(Map<String, String> preference) {
		String sectionUrl = "/seeyon/xkjtController.do?method=initList";
        //栏目url
        ...
        ht.addBottomButton(BaseSectionTemplete.BOTTOM_BUTTON_LABEL_MORE,"/xkjtController.do?method=daiYueMore",BaseSectionTemplete.OPEN_TYPE.href.name());
        return ht;
	}
