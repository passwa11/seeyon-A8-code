...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${path}/apps_res/xkjtBanjie/no_ban_jie_more.js${ctp:resSuffix()}"></script>
...
<div id="layout">
    <div class="layout_north bg_color" id="north">
        <div class="common_crumbs">
            <span class="margin_r_10">当前位置:</span><a href="javascript:void(0)">所有未办结</a>
        </div>
    </div>
