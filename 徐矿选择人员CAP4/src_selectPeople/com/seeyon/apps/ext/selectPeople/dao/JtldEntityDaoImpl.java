...
public class JtldEntityDaoImpl implements JtldEntityDao {
    ...
    public List<Map> selectJtldEntity() {
        String sql = "select t.id,t.state,t.start_member_id,t.start_date,t.approve_member_id,t.approve_date,t.finishedflag,t.ratifyflag,t.ratify_member_id,t.ratify_date,t.sort,t.modify_member_id,t.modify_date,t.field0001,t.field0002,t.field0003,t.field0004 from formmain_0150 t";
    ...
    public List<Map> selectFormmain0106() {
        String sql = "select t.field0010,t.field0011,t.field0012,t.field0013,m.name from FORMMAIN_0106 t  left join org_member m on t.field0011 = m.id where 1=1";
        List<Map> list = JDBCUtil.doQuery(sql);
        return list;
    }
    ...
    public List<Map> selectFormmain0087() {
        String sql = "select f.field0001,f.field0007,f.field0008,f.field0009,f.field0010,m.name from FORMMAIN_0087 f left join org_member m on f.field0007=m.id where 1=1";
        List<Map> list = JDBCUtil.doQuery(sql);
        return list;
    }
