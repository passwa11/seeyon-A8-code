...
public class JtldEntityDaoImpl implements JtldEntityDao {
    ...
    public List<Map<String,Object>> selectDeskWork(String name) {
        String sql = "select f.id,f.FIELD0001,f.FIELD0002,f.FIELD0005 zsort,f.FIELD0006 from formmain_0187 f where f.FIELD0002 like '%" + name + "%' order by zsort asc";
    ...
    public List<Map<String, Object>> selectFormmain0380(String name) {
        String sql = "select t.id,t.state,t.field0001,t.field0002,t.field0003,t.field0004,t.field0005 zsort,t.FIELD0006 from formmain_0380 t where t.field0003 like '%" + name + "%' order by zsort asc" ;
        List<Map<String,Object>> list = JDBCUtil.doQuery(sql);
        return list;
    }
    ...
    public List<Map<String,Object>> selectFormmain0106(String name) {
        String sql = "select t.field0010 field0002,t.field0011 field0001,t.field0012,t.field0013 field0004,m.name field0003,t.field0014 zsort,t.FIELD0015 field0006 from FORMMAIN_0106 t  left join org_member m on t.field0011 = m.id where t.field0013 like '%" + name + "%' order by zsort asc";
        List<Map<String,Object>> list = JDBCUtil.doQuery(sql);
        return list;
    }
    ...
    public List<Map<String,Object>> selectFormmain0087(String name) {
        String sql = "select f.field0001 field0002,f.field0007 field0001,f.field0008,f.field0009,f.field0012 field0004,m.name field0003,f.FIELD0011 zsort,f.FIELD0013 field0006 from FORMMAIN_0087 f left join org_member m on f.field0007=m.id where f.field0010 like '%" + name + "%' order by zsort asc";
        List<Map<String,Object>> list = JDBCUtil.doQuery(sql);
        return list;
    }
    ...
    public List<Map<String, Object>> selectFormmain0323(String name) {
        String sql = "select f.field0001 field0002,f.field0007 field0001,f.field0008,f.field0009,f.field0012 field0004,m.name field0003,f.FIELD0011 zsort,f.FIELD0013 field0006 from FORMMAIN_0323 f left join org_member m on f.field0007=m.id where f.field0010 like '%" + name + "%' order by zsort asc";
        List<Map<String,Object>> list = JDBCUtil.doQuery(sql);
        return list;
    }
