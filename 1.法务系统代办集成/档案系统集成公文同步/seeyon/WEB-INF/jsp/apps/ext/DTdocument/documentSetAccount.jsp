                    ...
                    <tr>
                        ...
                        <td class="new-column" width="80%">
                            <input class="input-100per" style="width: 200px;" type="text" name="record_user" id="record_user"
                                   maxlength="50" value="${requestScope.userPas!=null?requestScope.userPas.record_user:''}"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="new-column" width="80%">
                            <input class="input-100per" style="height: 28px;width: 200px;" type="password"
                                   name="record_pas" id="record_pas" maxlength="50"
                                   value="${requestScope.userPas.record_pas!=null?requestScope.userPas.record_pas:''}"/>
                        </td>
                    </tr>
                </table>
            </fieldset>
...
<script type="text/javascript">
    ...
    function setLaw() {
        ...
        $.post("/seeyon/ext/DTdocument.do?method=setResult", {
