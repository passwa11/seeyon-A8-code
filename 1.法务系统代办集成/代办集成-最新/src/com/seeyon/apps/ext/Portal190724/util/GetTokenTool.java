...
public class GetTokenTool {
    ...
    private static GetTokenTool getTokenTool;
    ...
    public static GetTokenTool getInstance() {
        if (null == getTokenTool) {
            getTokenTool = new GetTokenTool();
        }
        return getTokenTool;
    }
    ...
    public Map<String, Object> checkToken() {
        ...
        if (null != token && !"".equals(token)) {
            ...
            mapReturn.put("Timespan", String.valueOf(new Date().getTime() / 1000));
            mapReturn.put("AppKey", appKey);
        }
        return mapReturn;
    }
    ...
    public String getTokenByPost(String url, Map<String, String> map) {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                ResultInfo result = JSONObject.parseObject(jsonObject.get("result").toString(), ResultInfo.class);
