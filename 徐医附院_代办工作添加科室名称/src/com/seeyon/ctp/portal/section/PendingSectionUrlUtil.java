...
//                deadLineCell.setClassName(pendingRow.isOverTime() ? "colorRed" : "");
              ...
              if (rowStr.indexOf("sendUnit") != -1) {
                  ...
                  String sendunit=pendingRow.getSendUnit();
                  String name="";
                  if(sendunit.equals("")){
                      Long sendUserId=pendingRow.getCreateMemberId();
                      ...
                      name=(String) nameList.get(0).get("name");
                  }
                  sendUnitCell.setCellContentHTML(name);
